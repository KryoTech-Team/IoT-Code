...
firebase=firebase.FirebaseApplication('https://iot-based-database-default-rtdb.firebaseio.com/',None)
EMULATE_HX711=False
referenceUnit = 1
...
def sensor():
    ...
    result=firebase.post('https://iot-based-database-default-rtdb.firebaseio.com/Sensors',data)
    print(result)
    weight1 = Label(top, text = val,font=("Rockwell extra bold",80),bg='#7d2ae8').place(x = 1500,y = 460)
    temp1 = Label(top, text =t,font=("Rockwell extra bold",80),bg='#7d2ae8').place(x = 140,y = 460)
    hum1 = Label(top, text = h,font=("Rockwell extra bold",80),bg='#7d2ae8').place(x = 750, y = 460)
    title=Label(top,text="KRYO TECH",font=("Courier New",100),bg='#7d2ae8',fg="white").place(x=600,y=100)
    temp = Label(top, text = 'TEMPERATURE'+'('+u'\u00B0'+'C)',font=("Cooper black",40),bg='#7d2ae8').place(x = 140,y = 400)
    hum = Label(top, text = "RELATIVE HUMIDITY (%)",font=("Cooper black",40),bg='#7d2ae8').place(x = 750, y = 400)
    weight = Label(top, text = "WEIGHT (Kg)",font=("Cooper black",40),bg='#7d2ae8').place(x = 1500,y = 400)
    gas = Label(top, text = "GAS (ppm)",font=("Cooper black",40),bg='#7d2ae8').place(x = 140,y = 700)
    current = Label(top, text = "CURRENT (Amps)",font=("Cooper black",40),bg='#7d2ae8').place(x = 750,y = 700)
    gas1 = Label(top, text =ain0,font=("Rockwell extra bold",80),bg='#7d2ae8').place(x = 140,y = 760)
    current1 = Label(top, text = ampsA0,font=("Rockwell extra bold",80),bg='#7d2ae8').place(x = 750, y = 760)
    power = Label(top, text = "POWER (Watts)",font=("Cooper black",40),bg='#7d2ae8').place(x = 1500,y = 700)
    power1 = Label(top, text =pwr,font=("Rockwell extra bold",80),bg='#7d2ae8').place(x = 1500,y = 760)
